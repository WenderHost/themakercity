...
function send_password_reset_email( $user_email ) {
  ...
  if ( !$user ) {
    return new \WP_Error( 'no_user_found', 'No user found with that email address.<ol style="margin-top: 1em;"><li>If you already have a Maker Profile, <a href="mailto:support@themarkercity.org?subject=Lookup%20My%20Account">email us</a>, and we can lookup the email address associated with your profile.</li><li>Otherwise, <a href="' . home_url( 'sign-up' ) . '">sign up</a> for a new account.</li></ol>' );
  }
